    ...
    <div className="min-h-screen bg-background relative overflow-hidden meteor-cursor">
      <style jsx global>{`
        ...
        .animate-continuous-flow {
          animation: continuous-flow 20s linear infinite;
        }
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-[80vh] px-6">
        <div className="text-center max-w-4xl mx-auto">
          <div className="relative mb-8">
            ...
            {isLoaded && user && (
              <div 
                className="mt-6 animate-gentle-fade-in"
                style={{ animationDelay: "0.4s" }}
              >
                <p className="text-lg text-gray-300">
                  Welcome back, <span className="font-semibold text-white">{user.firstName || user.emailAddresses[0]?.emailAddress}</span>!
                </p>
              </div>
            )}
          </div>
          ...
          >
            ...
            >
              {isLoaded && user ? "Continue Journey" : "Start Exploring"}
            </Button>
